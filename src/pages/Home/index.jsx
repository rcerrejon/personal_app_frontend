      ...
      >
        <div className={profileContainerWrap}>
          ...
          >
            ...
            />
            <BtnYellowHome
              onClick={() => _openInNewTab('https://github.com/Imlerix')}
              currTheme={this.props.common.theme}
            >
        ...
        <div className={infoContainer}>
          <div className={greetText}>
            {this.props.common.lang === 'en' ? (
              <div>
                <span className={greetItem}>Hi,</span>
                <br className={noBrMobile} />
                <span className={greetItem}>i'm Vadim,</span>
                <br />
                <span className={greetItem}>web developer</span>
              </div>
            ) : (
              <div>
                <span className={greetItem}>Привет,</span>
                <br className={noBrMobile} />
                <span className={greetItem}>я Вадим,</span>
                <br />
                <span className={greetItem}>веб разработчик</span>
              </div>
            )}
          </div>
